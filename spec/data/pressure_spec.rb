  ...
  describe Pressure do
    describe ".initialize" do
      ...
      describe "sets unit type when given" do
        it "defaults to metric" do
          distance = Pressure.new(nil, nil)
          distance.should be_metric
        end

        it "sets metric via boolean" do
          distance = Pressure.new(true, nil, nil)
          distance.should be_metric
        end

        it "sets metric via symbol" do
          distance = Pressure.new(:metric, nil, nil)
          distance.should be_metric
        end

        it "sets imperial via boolean" do
          distance = Pressure.new(false, nil, nil)
          distance.should_not be_metric
        end

        it "sets imperial via symbol" do
          distance = Pressure.new(:imperial, nil, nil)
          distance.should_not be_metric
        end
    ...
    describe "#in" do
      ...
      it "returns converted known value as in" do
        distance = Pressure.new(:metric, 721.64)
        distance.in.should == 21.3
      end

      # it "keeps integer resolution" do
      #   distance = Pressure.new(:imperial, 10)
      #   distance.mb.should == 16
      # end

      # it "keeps float resolution" do
      #   distance = Pressure.new(:imperial, 10.0)
    ...
    describe "#mb" do
      ...
      it "returns converted known value as mb" do
        distance = Pressure.new(:imperial, 21.31)
        distance.mb.should == 721.6
      end
    ...
    describe "#<=>" do
      context "when comparing two metric distances" do
        it "returns > correctly" do
          distance1 = Pressure.new(:metric, 721, nil)
          distance2 = Pressure.new(:metric, 721.64, nil)
        ...
        it "returns == correctly" do
          distance1 = Pressure.new(:metric, 721, nil)
          distance2 = Pressure.new(:metric, 721.0, nil)
      ...
      context "when comparing two imperial distances" do
        it "returns > correctly" do
          distance1 = Pressure.new(:imperial, nil, 21)
          distance2 = Pressure.new(:imperial, nil, 21.31)
        ...
        it "returns == correctly" do
          distance1 = Pressure.new(:imperial, nil, 21)
          distance2 = Pressure.new(:imperial, nil, 21.0)
      ...
      context "when comparing a metric and an imperial distance" do
        it "returns > correctly" do
          distance1 = Pressure.new(:metric, 721.0, nil)
          distance2 = Pressure.new(:imperial, nil, 21.31)
        ...
        it "returns == correctly" do
          distance1 = Pressure.new(:metric, 721.64, nil)
          distance2 = Pressure.new(:imperial, nil, 21.31)
        ...
        it "returns < correctly" do
          distance1 = Pressure.new(:metric, 721.9, nil)
          distance2 = Pressure.new(:imperial, nil, 21.31)
    ...
    describe "#to_f" do
      context "when distance is metric" do
        it "returns the value of mb" do
          distance = Pressure.new(:metric, 721, 21)
      ...
      context "when distance is imperial" do
        it "returns the value of in" do
          distance = Pressure.new(:imperial, 721, 21)
    ...
    describe "#to_s" do
      context "when distance is metric" do
        it "returns mb" do
          distance = Pressure.new(:metric, 721, nil)
          distance.to_s.should == '721 mb'
        end
      end
      ...
      context "when distance is imperial" do
        it "returns in" do
          distance = Pressure.new(:imperial, nil, 21)
          distance.to_s.should == '21 in'
        end
      end
    end
