  ...
  describe Distance do
    describe ".initialize" do
      ...
      describe "sets unit type when given" do
        it "defaults to metric" do
          distance = Distance.new(nil, nil)
          distance.should be_metric
        end

        it "sets metric via boolean" do
          distance = Distance.new(true, nil, nil)
          distance.should be_metric
        end

        it "sets metric via symbol" do
          distance = Distance.new(:metric, nil, nil)
          distance.should be_metric
        end

        it "sets imperial via boolean" do
          distance = Distance.new(false, nil, nil)
          distance.should_not be_metric
        end

        it "sets imperial via symbol" do
          distance = Distance.new(:imperial, nil, nil)
          distance.should_not be_metric
        end
    ...
    describe "#m" do
      ...
      it "returns converted known value as m" do
        distance = Distance.new(:metric, 42.2)
        distance.m.should == 26.2
      end

      # it "keeps integer resolution" do
      #   distance = Distance.new(:imperial, 10)
      #   distance.km.should == 16
      # end

      # it "keeps float resolution" do
      #   distance = Distance.new(:imperial, 10.0)
    ...
    describe "#km" do
      ...
      it "returns converted known value as km" do
        distance = Distance.new(:imperial, 26.2)
        distance.km.should == 42.2
      end
    ...
    describe "#<=>" do
      context "when comparing two metric distances" do
        it "returns > correctly" do
          distance1 = Distance.new(:metric, 42, nil)
          distance2 = Distance.new(:metric, 42.2, nil)
        ...
        it "returns == correctly" do
          distance1 = Distance.new(:metric, 42, nil)
          distance2 = Distance.new(:metric, 42.0, nil)
      ...
      context "when comparing two imperial distances" do
        it "returns > correctly" do
          distance1 = Distance.new(:imperial, nil, 26)
          distance2 = Distance.new(:imperial, nil, 26.2)
        ...
        it "returns == correctly" do
          distance1 = Distance.new(:imperial, nil, 26)
          distance2 = Distance.new(:imperial, nil, 26.0)
      ...
      context "when comparing a mtric and an imperial distance" do
        it "returns > correctly" do
          distance1 = Distance.new(:metric, 42.0, nil)
          distance2 = Distance.new(:imperial, nil, 26.2)
        ...
        it "returns == correctly" do
          distance1 = Distance.new(:metric, 42.2, nil)
          distance2 = Distance.new(:imperial, nil, 26.2)
        ...
        it "returns < correctly" do
          distance1 = Distance.new(:metric, 42.3, nil)
          distance2 = Distance.new(:imperial, nil, 26.2)
    ...
    describe "#units" do
      context "when distance is metric" do
        it "returns km" do
          distance = Distance.new(:metric, 42.0, 26.0)
      ...
      context "when distance is imperial" do
        it "returns m" do
          distance = Distance.new(:imperial, 42.0, 26.0)
    ...
    describe "#to_f" do
      context "when distance is metric" do
        it "returns the value of km" do
          distance = Distance.new(:metric, 42, 26)
      ...
      context "when distance is imperial" do
        it "returns the value of m" do
          distance = Distance.new(:imperial, 42, 26)
    ...
    describe "#to_s" do
      context "when distance is metric" do
        it "returns km" do
          distance = Distance.new(:metric, 42, nil)
          distance.to_s.should == '42 km'
        end
      end
      ...
      context "when distance is imperial" do
        it "returns m" do
          distance = Distance.new(:imperial, nil, 26)
          distance.to_s.should == '26 m'
        end
      end
    end
