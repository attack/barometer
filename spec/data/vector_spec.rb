  ...
  describe Vector do
    describe ".initialize" do
      ...
      describe "sets unit type when given" do
        ...
        it "sets metric via boolean" do
          vector = Vector.new(true, nil, nil, nil)
          vector.should be_metric
        end

        it "sets metric via symbol" do
          vector = Vector.new(:metric, nil, nil, nil)
          vector.should be_metric
        end

        it "sets imperial via boolean" do
          vector = Vector.new(false, nil, nil, nil)
          vector.should_not be_metric
        end

        it "sets imperial via symbol" do
          vector = Vector.new(:imperial, nil, nil, nil)
          vector.should_not be_metric
        end
        ...
        context "when only provided one magnitude" do
          context "and metric is set" do
            it "interprets magnitude as kph" do
              vector = Vector.new(:metric, 20, 270)
              vector.metric = false
              vector.metric = true
              vector.to_s.should == "20 kph @ 270 degrees"
            end
          ...
          context "and imperial is set" do
            it "interprets magnitude as mph" do
              vector = Vector.new(:imperial, 10, 270)
              vector.metric = true
              vector.metric = false
              vector.to_s.should == "10 mph @ 270 degrees"
            end
    ...
    describe "#mph" do
      ...
      it "returns converted known value as mph" do
        vector = Vector.new(:metric, 16, nil)
        vector.mph.should == 10
      end
      ...
      #   vector = Vector.new(:imperial, 10.0, nil)
    ...
    describe "#<=>" do
      context "when comparing two metric vectors" do
        it "returns > correctly" do
          vector1 = Vector.new(:metric, 20, nil, nil)
          vector2 = Vector.new(:metric, 20.1, nil, nil)
        ...
        it "returns == correctly" do
          vector1 = Vector.new(:metric, 20, nil, nil)
          vector2 = Vector.new(:metric, 20.0, nil, nil)
      ...
      context "when comparing two imperial vectors" do
        it "returns > correctly" do
          vector1 = Vector.new(:imperial, nil, 10, nil)
          vector2 = Vector.new(:imperial, nil, 10.1, nil)
        ...
        it "returns == correctly" do
          vector1 = Vector.new(:imperial, nil, 10, nil)
          vector2 = Vector.new(:imperial, nil, 10.0, nil)
      ...
      context "when comparing a mtric and an imperial vector" do
        it "returns > correctly" do
          vector1 = Vector.new(:metric, 16.0, nil, nil)
          vector2 = Vector.new(:imperial, nil, 10.0, nil)
        ...
        it "returns == correctly" do
          vector1 = Vector.new(:metric, 16.1, nil, nil)
          vector2 = Vector.new(:imperial, nil, 10.0, nil)
        ...
        it "returns < correctly" do
          vector1 = Vector.new(:metric, 16.2, nil, nil)
          vector2 = Vector.new(:imperial, nil, 10.0, nil)
    ...
    describe "#to_f" do
      context "when vector is metric" do
        it "returns the value of kph" do
          vector = Vector.new(:metric, 20, 10, nil)
      ...
      context "when vector is imperial" do
        it "returns the value of mph" do
          vector = Vector.new(:imperial, 20, 10, nil)
