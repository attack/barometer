  ...
  describe Temperature do
    describe ".initialize" do
      ...
      describe "delays unit selection after init" do
        ...
        context "when initialized with F only" do
          it "allows imperial to be chosen after" do
            temperature = Temperature.new(68)
            temperature.metric = false
      ...
      describe "sets unit type when given" do
        it "defaults to metric" do
          temperature = Temperature.new(nil, nil)
          temperature.should be_metric
        end

        it "sets metric via boolean" do
          temperature = Temperature.new(true, nil, nil)
          temperature.should be_metric
        end

        it "sets metric via symbol" do
          temperature = Temperature.new(:metric, nil, nil)
          temperature.should be_metric
        end

        it "sets imperial via boolean" do
          temperature = Temperature.new(false, nil, nil)
          temperature.should_not be_metric
        end

        it "sets imperial via symbol" do
          temperature = Temperature.new(:imperial, nil, nil)
          temperature.should_not be_metric
        end
    ...
    describe "#m" do
      ...
      #   temperature = Temperature.new(:imperial, 10)
      #   temperature.c.should == 16
      # end

      # it "keeps float resolution" do
      #   temperature = Temperature.new(:imperial, 10.0)
    ...
    describe "#<=>" do
      context "when comparing two metric temperatures" do
        it "returns > correctly" do
          temperature1 = Temperature.new(:metric, 20, nil)
          temperature2 = Temperature.new(:metric, 20.2, nil)
        ...
        it "returns == correctly" do
          temperature1 = Temperature.new(:metric, 20, nil)
          temperature2 = Temperature.new(:metric, 20.0, nil)
      ...
      context "when comparing two imperial temperatures" do
        it "returns > correctly" do
          temperature1 = Temperature.new(:imperial, nil, 68)
          temperature2 = Temperature.new(:imperial, nil, 68.2)
        ...
        it "returns == correctly" do
          temperature1 = Temperature.new(:imperial, nil, 68)
          temperature2 = Temperature.new(:imperial, nil, 68.0)
      ...
      context "when comparing a mtric and an imperial temperature" do
        it "returns > correctly" do
          temperature1 = Temperature.new(:metric, 20.0, nil)
          temperature2 = Temperature.new(:imperial, nil, 68.2)
        ...
        it "returns < correctly" do
          temperature1 = Temperature.new(:metric, 20.3, nil)
          temperature2 = Temperature.new(:imperial, nil, 68.0)
    ...
    describe "#units" do
      context "when temperature is metric" do
        it "returns C" do
          temperature = Temperature.new(:metric, 20.0, 68.0)
      ...
      context "when temperature is imperial" do
        it "returns F" do
          temperature = Temperature.new(:imperial, 20.0, 68.0)
    ...
    describe "#to_f" do
      context "when temperature is metric" do
        it "returns the value of C" do
          temperature = Temperature.new(:metric, 20, 68)
      ...
      context "when temperature is imperial" do
        it "returns the value of F" do
          temperature = Temperature.new(:imperial, 20, 68)
    ...
    describe "#to_s" do
      context "when temperature is metric" do
        it "returns C" do
          temperature = Temperature.new(:metric, 20, nil)
          temperature.to_s.should == '20 C'
        end
      end
      ...
      context "when temperature is imperial" do
        it "returns F" do
          temperature = Temperature.new(:imperial, nil, 68)
          temperature.to_s.should == '68 F'
        end
      end
    end
    ...
    describe "#nil?" do
      ...
      it "returns false if only C set" do
        temperature = Temperature.new(20, nil)
        temperature.should_not be_nil
      end

      it "returns false if only F set" do
        temperature = Temperature.new(nil, 68)
        temperature.should_not be_nil
      end
    end
