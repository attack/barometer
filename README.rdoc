...
Currently this project is in development and will only work for one weather
service (wunderground), and only for the current time.

Features to be added before first release:
- more weather service drivers (yahoo, google)
