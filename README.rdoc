...
Currently this project is in development and does not completely work as described
below, although it is really close.

- DONE data classes (distance, pressure, speed, temperature, units)
- DONE measurement classes (measurement, current_measurement, forecast_measurement)
- DONE weather service drivers (wunderground)
- DONE general weather service class (service)
 
- TODO barometer class
- TODO weather class
- TODO weather service drivers (google, yahoo, etc.)
